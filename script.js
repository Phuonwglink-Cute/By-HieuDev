...
const state = {
  tracks: [
    { title: 'Cưới Luôn Được Không Remix', artist: 'Phuong Linh', src: 'music1.mp3', cover: 'music.JPG' },
    { title: 'Chấp Niệm Trong Em Remix', artist: 'Phuong Linh', src: 'music2.mp3', cover: 'music.JPG' },
  ],
  current: 0,
  repeat: false,
  muted: false,
...
window.addEventListener('load', () => {
  ...
  loadTrack(0, false);
  toggleMute(false);
  try { audio.preload = 'metadata'; audio.load(); } catch (e) {}
});
